...
import { VerificationScreen, VerificationScreenState } from "../components/verification-screen";
...
export default function VerifyPage() {
  ...
  const [screenState, setScreenState] = useState<VerificationScreenState>("initial");
  ...
  const handleVideoRecorded = async (videoData: RecordedVideoData) => {
    ...
    try {
      ...
      const updatedItems = await processVideo(videoData, checklistItems, newAttemptCount);
